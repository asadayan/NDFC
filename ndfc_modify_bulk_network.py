...
ndfc_token = ndfc_auth.auth(ndfc_credentials.node_ip,ndfc_tokenusername,password)
...
for vrfName in vrf_list:
    ...
    for net in range(1,num_of_net_per_vrf+1):
        ...
        network_dict['networkTemplateConfig']['suppressArp'] = suppressArp
        posturl = url + f'/appcenter/cisco/ndfc/api/v1/lan-fabric/rest/top-down/fabrics/Agilent-POC/networks/{network_dict["displayName"]}'
        if ipv6_flag == 1:
